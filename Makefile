...
bankwallets: generate_public_key witness_for_withdrawal_wallets iswithdrawable_keccac
bankwallets_wasm: generate_public_key_wasm witness_for_withdrawal_wallets_wasm bankwallets_single_wasm iswithdrawable_keccac_wasm
...
iswithdrawable_keccac: src/bankwallets/iswithdrawable_keccac.c cyclic_group.o
	$(CC) -o bin/bankwallets/iswithdrawable_keccac  src/bankwallets/iswithdrawable_keccac.c src/commons/cyclic_group.o $(IOPT) $(LDFLAGS) $(CCOPT) $(DFLAGS) 
encrypt_keccac_wasm: 
...
iswithdrawable_keccac_wasm: 
	$(EMCC) -o js/bankwallets/iswithdrawable_keccac.html  src/bankwallets/iswithdrawable_keccac.c SHA3IUF/sha3.c src/commons/cyclic_group.c $(IOPTWASM) $(LDFLAGSWASM)
bankwallets_single_wasm: 
	$(EMCC) -o js/bankwallets/bankwallets_single.html  src/bankwallets/witness_for_withdrawal.c src/bankwallets/generate_public_key.c src/bankwallets/iswithdrawable_keccac.c src/commons/encrypt_keccac.c SHA3IUF/sha3.c src/commons/cyclic_group.c $(IOPTWASM) $(LDFLAGSWASM)
clean:
